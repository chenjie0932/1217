package com.bwie.test.lianxi1128.utils;
...
import com.bwie.test.lianxi1128.application.Myaplication;


public class CommonUtils {
    public static Context getContext() {
        return Myaplication.getContext();
    }

    public static Handler getHandler() {
        return Myaplication.getHandler();
    }
